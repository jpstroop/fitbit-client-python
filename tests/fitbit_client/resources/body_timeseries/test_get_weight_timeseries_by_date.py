...
def test_get_weight_timeseries_by_date_period_validation(body_timeseries):
    ...
    for period in invalid_periods:
        with raises(ValidationException) as exc_info:
            body_timeseries.get_weight_timeseries_by_date(date="2023-01-01", period=period)
...
def test_get_weight_timeseries_by_date_makes_correct_request(body_timeseries, mock_response):
    ...
    body_timeseries.oauth.request.assert_called_once_with(
        "GET",
        "https://api.fitbit.com/1/user/test_user/body/log/weight/date/2023-01-01/1w.json",
        params=None,
        data=None,
        json=None,
